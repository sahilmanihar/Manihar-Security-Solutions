...
export default function Services() {
    return (
        <section id="services" className="py-20 px-6 md:px-20 bg-black text-white">
            <h2 className="text-3xl md:text-6xl font-bold text-center mb-14 "><span className="bg-gradient-to-r from-blue-600 to-red-600 bg-clip-text text-transparent">Our Services</span></h2>
